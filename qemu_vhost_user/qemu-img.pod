...
=item B<convert [-c] [-p] [-q] [-n] [-f> I<fmt>B<] [-t> I<cache>B<] [-O> I<output_fmt>B<] [-o> I<options>B<] [-s> I<snapshot_id_or_name>B<] [-l> I<snapshot_param>B<] [-S> I<sparse_size>B<]> I<filename> B<[>I<filename2> B<[...]]> I<output_filename>
...
=item B<amend [-q] [-f> I<fmt>B<] -o> I<options>B< >I<filename>
...
=item B<convert [-c] [-p] [-n] [-f> I<fmt>B<] [-t> I<cache>B<] [-O> I<output_fmt>B<] [-o> I<options>B<] [-s> I<snapshot_id_or_name>B<] [-l> I<snapshot_param>B<] [-S> I<sparse_size>B<]> I<filename> B<[>I<filename2> B<[...]]> I<output_filename>
...
=item B<amend [-f> I<fmt>B<] -o> I<options>B< >I<filename>
