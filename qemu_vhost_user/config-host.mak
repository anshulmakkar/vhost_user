...
libs_softmmu=-lutil -lbluetooth   -lcurl   -lncurses   -lbrlapi  -lvdeplug -luuid -lpng12   -lsasl2 -lgnutls   -lSDL   -lX11  -lz -lrdmacm -libverbs -laio  -lspice-server   -lpixman-1  
ARCH=x86_64
CONFIG_DEBUG_TCG=y
CONFIG_POSIX=y
CONFIG_LINUX=y
...
VERSION=1.7.50
PKGVERSION=
SRC_PATH=/home/amakkar/vhost_user/qemu_vhost_user_git
...
LIBTOOL=libtool
CFLAGS=-g   
QEMU_CFLAGS=-fPIE -DPIE -m64 -D_GNU_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Wstrict-prototypes -Wredundant-decls -Wall -Wundef -Wwrite-strings -Wmissing-prototypes -fno-strict-aliasing  -Wendif-labels -Wmissing-include-dirs -Wempty-body -Wnested-externs -Wformat-security -Wformat-y2k -Winit-self -Wignored-qualifiers -Wold-style-declaration -Wold-style-definition -Wtype-limits -fstack-protector-all -I/usr/include/p11-kit-1    -I/usr/include/libpng12   -I/usr/include/spice-server -I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include -I/usr/include/pixman-1 -I/usr/include/spice-1   -I/usr/include/pixman-1   
QEMU_INCLUDES=-I$(SRC_PATH)/tcg -I$(SRC_PATH)/tcg/i386 -I$(SRC_PATH)/linux-headers -I/home/amakkar/vhost_user/qemu_vhost_user_git/linux-headers -I. -I$(SRC_PATH) -I$(SRC_PATH)/include
AUTOCONF_HOST := 
LDFLAGS=-Wl,--warn-common -Wl,-z,relro -Wl,-z,now -pie -m64 -g 
LIBTOOLFLAGS= -Wc,-fstack-protector-all
LIBS+=-lrt -pthread -lgthread-2.0 -lglib-2.0    -liscsi  
LIBS_TOOLS+=-lcurl   -lvdeplug -luuid  -laio
EXESUF=
